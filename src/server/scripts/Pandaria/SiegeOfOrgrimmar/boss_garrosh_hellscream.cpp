...
// 9412, 9416, 9417, 9418, 9419, 9420, 9421, 9422
class at_soo_garrosh_fire_pit : public AreaTriggerScript
{
    public:
        at_soo_garrosh_fire_pit() : AreaTriggerScript("at_soo_garrosh_fire_pit") { }
...
class at_entity_korkron_iron_star : public AreaTriggerEntityScript
{
    public:
        at_entity_korkron_iron_star() : AreaTriggerEntityScript("at_entity_korkron_iron_star") { }

        void OnUnitEnter(AreaTrigger* areaTrigger, Unit* unit) override
        {
            if (areaTrigger->GetCaster() == unit)
                return;
