...
CREATE TABLE IF NOT EXISTS `creature_template_personal` (
  `Entry` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'This is the Entry of the generic creature that will be kept for everyone else but the summoner on UpdateObject packet.',
  `EntryForSummoner` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'This is the EntryID of the creature that will be switched for the summoner of the spell on UpdateObject packet.',
